...
def test_selected_subtask_alone_exports_only_subtask(tmp_path) -> None:
    ...
    service.add_manual_interval(
        parent, _local("2026-01-01 10:00"), _local("2026-01-01 11:00"), "p"
    )
    service.add_manual_interval(
        child, _local("2026-01-01 12:00"), _local("2026-01-01 13:00"), "c"
    )
...
def test_selected_parent_and_child_are_normalized_no_double_count_and_marker_records_inclusion(
    ...
    service.add_manual_interval(
        child, _local("2026-01-01 11:00"), _local("2026-01-01 12:00"), "c"
    )
